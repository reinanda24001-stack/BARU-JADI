                    ...
                    <Section title="Waktunya Tiup Lilin!" id="candle">
                        <div className="max-w-md mx-auto bg-white/70 backdrop-blur-sm p-8 rounded-lg shadow-lg">
                            <div className="relative w-64 h-80 mx-auto mb-4">
                                {/* Plate */}
                                <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-[110%] h-6 bg-slate-300 rounded-[50%]"></div>
                                
                                {/* Bottom Tier */}
                                <div className="absolute bottom-[4.5rem] left-1/2 -translate-x-1/2 w-56 h-24 bg-pink-400 rounded-md">
                                    <div className="absolute -top-6 w-[105%] left-1/2 -translate-x-1/2 h-10 bg-orange-50 rounded-t-[50%] rounded-b-[20%]"></div>
                                    <div className="w-full h-full flex justify-evenly items-center px-2">
                                        {[...Array(4)].map((_, i) => (
                                            <span key={i} className={`w-5 h-5 rounded-full ${i % 2 === 0 ? 'bg-orange-50' : 'bg-pink-200'}`}></span>
                                        ))}
                                    </div>
                                </div>
                            
                                {/* Top Tier */}
                                <div className="absolute bottom-[10.5rem] left-1/2 -translate-x-1/2 w-40 h-20 bg-pink-400 rounded-md">
                                    <div className="absolute -top-5 w-[105%] left-1/2 -translate-x-1/2 h-8 bg-orange-50 rounded-t-[50%] rounded-b-[20%]"></div>
                                    <div className="w-full h-full flex justify-evenly items-center px-2">
                                        {[...Array(3)].map((_, i) => (
                                            <span key={i} className={`w-4 h-4 rounded-full ${i % 2 === 0 ? 'bg-orange-50' : 'bg-pink-200'}`}></span>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    {!isCandleBlown ? (
                                        <>
                                            {[
                                                ...
                                                <div key={i} className="candle" style={{ height: style.height }}>
                                        ...
                                        <div className="relative w-full h-12 -top-8">
                                            {[...Array(9)].map((_, i) => (
                                                <div 
                                                    key={i}
